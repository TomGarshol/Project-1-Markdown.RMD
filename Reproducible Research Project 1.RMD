...
goal of this project is as follows
...
The average number of steps is 10766 in
...
Note: 2304 is missed and filled with NA Now we are using the mean to fill in the missing data, create a new dataset is equal to the original data but using the mean to fill in the missing data as the following:
